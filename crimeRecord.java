...
class CrimeRecordManagementGUI extends JFrame {
    ...
    private void showSearchRecordDialog() {
        String input = JOptionPane.showInputDialog(this, "Enter the serial number of the record to search:");
    ...
    private void showRecordDetails(CrimeRecord record) {
        // Display the details of the searched record
        String details = "Serial Number: " + record.getSerialNumber() + ", Crime: " + record.getCrimeName() +
                ", Suspect: " + record.getSuspectName() + ", Date: " + record.getDate();
        JOptionPane.showMessageDialog(this, details, "Record Details", JOptionPane.INFORMATION_MESSAGE);
    }
